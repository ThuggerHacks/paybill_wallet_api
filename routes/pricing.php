...
Route::get("/cards/{id?}",[PricingController::class,"cardById"])->middleware("api_auth","email_verification");
...
Route::put("/cards/update/pro",[PricingController::class,"upgradeAccount"])->middleware("api_auth","email_verification");
